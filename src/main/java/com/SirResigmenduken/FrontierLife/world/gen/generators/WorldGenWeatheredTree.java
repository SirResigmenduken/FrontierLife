...
public class WorldGenWeatheredTree extends WorldGenAbstractTree 
{
	public static final IBlockState LOG = BlockInit.LOGS.getDefaultState().withProperty(BlockLogs.VARIANT, CustomTreeEnumHandler.EnumType.WEATHERED);
	
	private final int minHeight;
	
	public WorldGenWeatheredTree() 
	{
		super(false);
		this.minHeight = 5;
	}
